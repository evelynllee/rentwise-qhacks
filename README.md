...
This project is not fully functional due to missing files and incomplete features. Unfortunately, some key files were lost during the development process, and the backend or some functionalities may not work as intended.

## My Contributions 

I was responsible for designing the website and implementing the front-end. Despite the missing files, my work includes:
